...
//lot of variables to draw the map.

var MAP = {tw: 60,th: 15};
 //^Specifies how big your level is.

var TILE=35;
 //^The width/height of a tile (in pixels).
...
//loads the tileset for the level.
...
//Calculation for map movement
function cellAtPixelCoord(layer, x,y)
{
	if(x<0 || x>SCREEN_WIDTH || y<0)
			return 1;
	//Allows the player to drop off the bottom of the screen(aka death)
	if(y>SCREEN_HEIGHT)
			return 0;
...
function run()
{
	...
	context.fillText("FPS: " + fps, 5, 450, 100);
	
	
	//score
	context.drawImage(enemyImage, SCREEN_WIDTH - 100, 5);
	context.fillStyle = "yellow";
	context.font="32px Arial";
	var scoreText = "X" + score;
	context.fillText(scoreText, SCREEN_WIDTH - 50, 35);
		
	//Health
	context.drawImage(heartImage, SCREEN_WIDTH - 630, 5);
	//Health Live Contour
	context.font="32px Arial";
	...
	context.strokeText(scoreText, SCREEN_WIDTH - 580, 35);
